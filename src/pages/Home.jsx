...
function Home() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    navigate(`../home/search?title=${search.trim()}`);
  };
        ...
        <div className="max-w-[1440px] mx-auto sm:pt-4 lg:flex lg:py-8 lg:container">
          ...
          <main className="lg:container lg:w-full">
            <div className="sm:container mx-auto p-4 smxl:container">
              ...
              {/* trending */}
              <h2 className="text-xl text-white py-8">Trending</h2>
              <div className="flex flex-col gap-2 text-white font-light overflow-x-auto custom_scroll">
                    ...
                    data
                      ...
                      .map((item, index) => (
                        <div
                          ...
                          className="flex flex-col relative group bg-center bg-cover rounded-lg w-full max-w-[240px] min-w-[240px] min-h-[140px] p-2 justify-between sm:max-w-[470px] sm:max-h-[230px] md:min-w-[470px] md:min-h-[230px]"
                        >
                          <div className="flex">
                          ...
                          <div className="flex justify-between px-2 items-center">
                            ...
                            <div className="bg-white/15 px-2 rounded-[10px]">
                              {/* rating */}
                              <span className="text-[13px]">{item.rating}</span>
                            </div>
                          </div>
                          {/* hidden play button */}
                          <div className="hidden absolute group-hover:flex pointer-events-none top-0 left-0 w-full h-full  justify-center items-center bg-black/40 z-20 ">
                            {/* play */}
                            <button
              ...
              {/* recommended */}
              <h2 className="text-xl text-white py-8">Recomended for you</h2>
